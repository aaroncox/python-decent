.. python-decent documentation master file, created by
...
Welcome to pydecent's documentation!
===============================================

decent is a **blockchain-based autonomous company** (i.e. a DAC) that
...
solution. In case of decent, it comes with decentralized gaming
engine and allows setting up and running tournaments of any kind.

About this Library
------------------

The purpose of *pydecent* is to simplify development of products and
services that use the decent blockchain. It comes with
