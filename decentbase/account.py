...
class Address(GPHAddress):
    """ Address class
        ...
        :param str prefix: Network prefix (defaults to ``DCT``)

        Example::

           Address("DCTFN9r6VYzBK8EKtMewfNbfiGCr56pHDBFi")

    """
    def __init__(self, *args, **kwargs):
        if "prefix" not in kwargs:
            kwargs["prefix"] = "DCT"  # make prefix DCT
...
class PublicKey(GPHPublicKey):
    """ This class deals with Public Keys and inherits ``Address``.
        ...
        Example:::
           ...
           PublicKey("DCT6UtYWWs3rkZGV8JA86qrgkG6tyFksgECefKE1MiH4HkLD8PFGL")
